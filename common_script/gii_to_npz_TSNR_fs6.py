...
# Parameters
nL = nR = 40962  # fsaverage5
tsnr_threshold = 62.0  # fixed threshold matching original 15th percentile

# Input tSNR file (fsaverage5)
tsnr_dscalar = "/scratch/groups/anishm/fmri/HCP_tSNR/HCP_PreProcd_group_average_tsnr_fs6.dscalar.nii"
...
# Save mask indices
out_dir = "/scratch/groups/anishm/fmri/HCP_tSNR/fs6"
from pathlib import Path
Path(out_dir).mkdir(exist_ok=True, parents=True)

mask_file = f"{out_dir}/mask_indices_fs6.npy"
